...
<!--chapter:end:02_tripgen.Rmd-->

# Trip Distribution {#chap-distribution}

<!--chapter:end:03_distribution.Rmd-->
...
are listed as `WorkTrips.Rdata`. We will also need to load the 
...
use. To do this, there needs to be a unique `IDFIELD` identification
...
models.  To do this, use the ``mlogit()` function, in a manner sort of like
you would use the `lm()` command. One thing to look out for: 
the difference
between generic and alternative-specific variables.^[This can be
...
<!--chapter:end:04_modechoice.Rmd-->

# Network Assignment and Validation {#chap-assignment}

<!--chapter:end:05_assignment.Rmd-->

# The Planning Process {#chap-process}

<!--chapter:end:06_process.Rmd-->
...
<!--chapter:end:11_app_demomodel.Rmd-->
...
<!--chapter:end:12_app_rstudio.Rmd-->
