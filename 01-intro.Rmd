...
```{r lm-mpg, fig.cap = "Relationship between engine displacement and miles per gallon.", echo = True}
...
\begin{equation}
  SSR(\hat{\beta}) = \sum(y - X\beta)^2
  (\#eq:ssr)
\end{equation}

If we take derivative of this with respect to $\beta$, set to zero, and solve
