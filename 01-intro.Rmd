...
nhts_households %>% 
  mutate(hhfaminc = as_factor(hhfaminc, levels = "values")) |> 
...
ut_tracts <- tracts("UT", "Utah", class = "sf", progress_bar = FALSE, year = 2010) %>%
  filter(TRACTCE10 %in% c("001601", "001504", "001602", "001603", "001701",
                        "001900", "001801", "001702", "001802", "001803",
                        "002400", "002500", "002701")) %>%
  select(GEOID = GEOID10, TRACTCE10) %>%
  st_transform(4236)

ut_bg <- block_groups("UT", "Utah", class = "sf", progress_bar = FALSE, year = 2010) %>%
  filter(TRACTCE10 %in% ut_tracts$TRACTCE10) %>%
  select(GEOID = GEOID10, TRACTCE10) %>%
  st_transform(4236)

ut_blks <- blocks("UT", "Utah", class = "sf", progress_bar = FALSE, year = 2010) %>%
  filter(TRACTCE10 %in% ut_tracts$TRACTCE10) %>%
