...
```{r rstudio-orientation, echo = FALSE}
knitr::include_url("http://www.youtube.com/embed/c3xv8wOIj-g?rel=0")
```


There is a very useful "cheat sheet" for working with RStudio on the [RStudio](https://resources.rstudio.com/rstudio-cheatsheets/rstudio-ide-cheat-sheet)
website.
