...
```{r file-access, echo = FALSE}
knitr::include_url("https://www.youtube.com/embed/Npw-jf19wak")
```
...
```{r,  echo = FALSE}
knitr::include_url("https://www.youtube.com/embed/okU6pu0KAiQ")
```
...
```{r linkdiff-video, echo = FALSE}
knitr::include_url("https://www.youtube.com/embed/BCSi0h7tbew")
```
...
```{r mcls-video, echo = FALSE}
knitr::include_url("https://www.youtube.com/embed/KjsTnkU1h1Y")
```
...
```{r transit-video, echo = FALSE}
knitr::include_url("https://www.youtube.com/embed/z0a268m_9TA")
```
